                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="hapusRole('<?= base_url('admin/hapus_role/') . $r['id'] ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<?php foreach ($role as $r) : ?>
    <div class="modal fade" id="editrole<?= $r['id'] ?>" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
