                    ...
                    <?php foreach ($submenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="badge badge-success" data-toggle="modal" data-popup="tooltip" data- placement="top" title="edit"data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</a>
 
                                <a href="#" onclick="hapusSubmenu('<?= base_url('menu/hapus/') . $sm['id'] ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
