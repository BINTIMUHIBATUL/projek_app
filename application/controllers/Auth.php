...
class Auth extends CI_Controller 
{
	...
	private function _sendEmail($token,$type)
	{
		...
		$config['smtp_user'] = 'manusiasaya886@gmail.com'; // email yang dirubah keamanannya
		$config['smtp_pass'] = 'aecohjrsnumygdlb';
		...
		$this->email->from('manusiasaya886@gmail.com','WEB RPL 1');
